...
With this new model, learners now see events hosted by a broader variety of groups in their region, and they no longer run the risk of discovering an inactive group when following a link from our chapters page to a chapter repository. However, our [archived chapter listings](https://proto.school/chapters) will remain accessible through the end of April 2020, after which that URL will redirect to our new [events page](https://proto.school/events).
